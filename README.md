...
### 1. [android-build-doctor](file:///e:/work/ag-android-build-doctor/skills/android-build-doctor/SKILL.md)
...
```bash
gh skill install <OWNER>/ag-android-developer-skills --agent antigravity
```
...
```bash
gh skill install <OWNER>/ag-android-developer-skills --agent antigravity --scope project
```
...
[LICENSE](file:///e:/work/ag-android-build-doctor/LICENSE) を参照してください。
